 ...
 */
public class TwoWayListView extends AdapterView<ListAdapter> implements
     ...
     *
     * @see TwoWayListView.RecycleBin
     * @see TwoWayListView#setRecyclerListener(TwoWayListView.RecyclerListener)
     */
    ...
    public TwoWayListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TwoWayListView, defStyle, 0);
        initializeScrollbars(a);

        mDrawSelectorOnTop = a.getBoolean(
                R.styleable.TwoWayListView_android_drawSelectorOnTop, false);

        Drawable d = a.getDrawable(R.styleable.TwoWayListView_android_listSelector);
        if (d != null) {
            setSelector(d);
        }

        int orientation = a.getInt(R.styleable.TwoWayListView_android_orientation, -1);
        if (orientation >= 0) {
            setOrientation(Orientation.values()[orientation]);
        }

        int choiceMode = a.getInt(R.styleable.TwoWayListView_android_choiceMode, -1);
        if (choiceMode >= 0) {
     ...
     *
     * @see TwoWayListView.RecycleBin
     * @see TwoWayListView.RecyclerListener
     */
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (listener != null) {
                handled = listener.onItemLongClick(TwoWayListView.this, originalView,
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(TwoWayListView.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(TwoWayListView.class.getName());
    ...
    private boolean performLongPress(final View child,
        ...
        OnItemLongClickListener listener = getOnItemLongClickListener();
        if (listener != null) {
            handled = listener.onItemLongClick(TwoWayListView.this, child,
                    longPressPosition, longPressId);
        }

        if (!handled) {
            mContextMenuInfo = createContextMenuInfo(child, longPressPosition, longPressId);
            handled = super.showContextMenuForChild(TwoWayListView.this);
        }
    ...
    private class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (TwoWayListView.this.mHasStableIds && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                TwoWayListView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (TwoWayListView.this.mHasStableIds) {
                // Remember the current state for the case where our hosting activity is being
                // stopped and later restarted
                mInstanceState = TwoWayListView.this.onSaveInstanceState();
            }
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link TwoWayListView#onSaveInstanceState()}
         */
    ...
    private static class ArrowScrollFocusResult {
        ...
        /**
         * How {@link TwoWayListView#arrowScrollFocused} returns its values.
         */
